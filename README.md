...
- 🔭 The open source team I'm working on is: [![](https://j2doll.github.io/j2doll/img/kr.png)](#) ```제가 진행 중인 오픈소스 팀은 다음과 같습니다:```
  ...
  - :zap: **Jay Two's Software Lab** : https://github.com/JayTwoLab [![](https://j2doll.github.io/j2doll/img/kr.png)](#) ```제이투의 소프트웨어 연구소```
	   ...
	   - [![C++](https://img.shields.io/badge/JayTwoLab-cpp-blue)](https://github.com/orgs/JayTwoLab/repositories?language=c%2B%2B) 
	   - [![Python](https://img.shields.io/badge/JayTwoLab-pytyhon-blue)](https://github.com/orgs/JayTwoLab/repositories?language=python) 
